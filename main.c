...
int main(void)
{
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            originalFunction = GuiCheckBox((Rectangle){ 600, 380, 20, 20 }, "Saw Wave/Sin Wave", originalFunction);
            //------------------------------------------------------------------------------
